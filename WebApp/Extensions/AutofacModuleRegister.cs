...
namespace WebApp.Extensions
{
    public class AutofacModuleRegister : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "WebApp.Services.dll");
            var repositoryDllFile = Path.Combine(basePath, "WebApp.Repository.dll");
            ...
            //var assemblysServicesNoInterfaces = Assembly.Load("WebApp.Services");
