...
using System.IO;
using System.Linq;
using static WebApp.SwaggerHelper.CustomApiVersion;
        ...
        public static void AddSwaggerSetup(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                try
                {
                    ...
                    /*  dto xml文档  */
                    var infrastructureXmlPath = Path.Combine(basePath, "Infrastructure.xml");//这个就是Model层的xml文件名
